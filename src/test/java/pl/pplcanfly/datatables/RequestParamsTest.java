...
import pl.pplcanfly.datatables.RequestParams;
...
public class RequestParamsTest {
    ...
    public void should_parse_sort_params() {
        ...
        params.put("bSortable_2", new String[]{"true"});
        params.put("bSortable_3", new String[]{"true"});
        params.put("bSortable_4", new String[]{"true"});
    ...
    @Test
    public void should_skip_non_sortable_columns() {
        // datatables always sorts first column by default even if it's not sortable
        ...
        params.put("sSortDir_0", new String[]{"asc"});
        params.put("sSortDir_1", new String[]{"asc"});

        params.put("bSortable_0", new String[]{"false"});
        params.put("bSortable_1", new String[]{"true"});
    ...
    public void should_parse_search_params() {
        ...
        params.put("sColumns", new String[]{"col1,col2,col3,col4,col5"});
        params.put("sSearch", new String[]{"searching for the meaning"});
        ...
        // then
        assertThat(request.getSearch()).isEqualTo("searching for the meaning");
